...
const Home = () => {
  return (
    <div className="container mx-auto flex items-center justify-center flex-wrap md:flex-no-wrap">
      ...
      <div className="w-full md:w-1/2 px-5 sm:px-10">
        ...
        <div className="mt-5 flex flex-wrap sm:flex-no-wrap justify-start align-middle">
          <Link to="/about">
            <div
              className="px-4 py-2 rounded-sm xs:text-sm sm:text-base font-semibold shadow-lg bg-blue-700 text-gray-100 border-solid border-2 border-blue-700 mr-4"
              href="#"
            >
              About Me
            </div>
          ...
          <Link to="contact">
            <div
              className="px-4 py-2 rounded-sm xs:text-sm sm:text-base font-semibold shadow-lg bg-gray-100 text-blue-700 border-solid border-2 border-blue-700"
              href="#"
            >
              Contact Me
            </div>
